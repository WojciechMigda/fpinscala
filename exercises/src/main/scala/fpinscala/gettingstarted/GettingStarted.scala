...
object TestIsSorted
{
    ...
    def main(args: Array[String]): Unit =
    {
        def p(p: Int, q: Int): Boolean =
        {
            p <= q
        }

        println("Expected: true")
        println("Actual: %b".format(isSorted(Array[Int](), p)))
        println("Expected: true")
        println("Actual: %b".format(isSorted(Array(1), p)))
        println("Expected: true")
        println("Actual: %b".format(isSorted(Array(1, 2), p)))
        println("Expected: false")
        println("Actual: %b".format(isSorted(Array(2, 1), p)))
        println("Expected: true")
        println("Actual: %b".format(isSorted(Array(1, 2, 3, 4), p)))
        println("Expected: true")
        println("Actual: %b".format(isSorted(Array(7, 7, 7), p)))
        println("Expected: false")
        println("Actual: %b".format(isSorted(Array(1, 2, 4, 3, 5), p)))
    }
}
